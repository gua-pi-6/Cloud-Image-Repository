...
.content-wrapper {
  ...
  padding: 40px 48px;
  border-radius: 24px;
  box-shadow: 0 20px 40px rgba(24, 144, 255, 0.06), 0 1px 2px rgba(0, 0, 0, 0.05);
...
:deep(.ant-select-focused:not(.ant-select-disabled).ant-select:not(.ant-select-customize-input) .ant-select-selector) {
  box-shadow: 0 0 0 4px rgba(24, 144, 255, 0.08) !important;
}
...
.submit-btn {
  ...
  font-weight: 600;
  border-radius: 12px;
  background: linear-gradient(90deg, #1476d6 0%, #1890ff 100%);
  border: none;
